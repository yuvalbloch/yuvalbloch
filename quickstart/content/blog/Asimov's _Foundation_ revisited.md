...
Consider, for example, the classic **Karate Club Network**, which I've already described in my post on conflicts [Empathy in the Emergent Storm](https://yuvalbloch.com/blog/post-2/)
 This real-world event involved a university karate club with just 34 members. A conflict arose between the instructor and the club's administrator, leading to a dramatic split of the entire club into two distinct factions.
...
This applies beyond markets. Many complex systems thrive on **natural decentralization**, allow them to solve challenging computational problems and often outperforming centralized approaches. Think of slime mold solving logistics better than city planners (see in [life on the edge](https://yuvalbloch.com/blog/life-on-the-edge/) in section Memory, Computation, and Becoming), or how organically grown cities outperform planned ones, natural system tend to become an efficient computer to solve specific problem.
