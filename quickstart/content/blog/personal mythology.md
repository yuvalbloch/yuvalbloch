...
<figure> <img src="/posts/mythology/locifer.jpg" alt="Jungian mandala" style="max-width:50%; height:auto; display:block; margin: 0 auto; border-radius: 12px;"> <figcaption style="font-size: 0.9em; color: #666; margin-top: 0.8rem; line-height: 1.5; padding: 0 1rem; text-align: center;">he figure of the Rebellious Angel, most famously the Christian Lucifer, serves as a powerful archetype of internal conflict</figcaption> </figure>
...
<figure> <img src="/posts/mythology/mentor.jpg " alt="Jungian mandala" style="max-width:50%; height:auto; display:block; margin: 0 auto; border-radius: 12px;"> <figcaption style="font-size: 0.9em; color: #666; margin-top: 0.8rem; line-height: 1.5; padding: 0 1rem; text-align: center;">Athena, guiding Telemachus in The Odyssey, is a classic example of the Divine Mentor archetype—a figure who provides knowledge and direction for the internal or external journey. </figure>
...
**Death** is an entity I _can_ speak with, but prefer not to. He is a very nice gentleman, yet quite frightening. I have agreed to stay out of his business, meaning I will speak with a **spirit** but never with a **ghost**.
...
<figure>
  <img src="/posts/open_u/kimono.jpg" 
       ...
       style="max-width: 50%; height: auto; display: block; margin: 0 auto; border-radius: 12px;">
...
painting eye on silk to create a kimono. connecting it to protecting powers
  </figcaption>
</figure>
