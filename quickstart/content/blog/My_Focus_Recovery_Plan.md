...
Research suggests two mind modes—the **focused mind** and the **lazy mind**—and that switching between them requires effort. Because the time spent with LLMs demands less effort, my mind often slips into _lazy mode_. When I transition back to a hard task, it requires significant time and energy to re-engage the _focused mode_. I frequently get stuck in a loop, trying to delegate tasks to the LLM that I know it can't handle, simply because I'm avoiding the cognitive strain of returning to focus mode. The literature suggests a solution: splitting time into dedicated, long, continuous blocks for focused work.
