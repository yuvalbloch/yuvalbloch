...
I'm wrapping up my first week of **intentionally improving my focus** based on my original [focus recovery plan](https://yuvalbloch.com/blog/my_focus_recovery_plan/). The results are already remarkable, and frankly, stronger than I anticipated.
...
More significantly, I observed a similar, but magnified, effect with **AI tools** like ChatGPT and Gemini. While these tools are highly useful, I found that consulting them _mid-session_ destroyed my flow.
...
1. **Yoga as a Constant:** The morning yoga session will become a constant, non-negotiable part of the daily plan.
    
2. **Simplified AI Blocks:** Instead of the complex method of odd/even hours for AI use, I will simplify: I will only consult AI for a half-hour period, specifically positioned **after an hour of deep work and before a scheduled break.**
    
3. **Location Change:** I will work 2–3 days a week from my garden to maximize exposure to nature.
...
[1] Isbell, Elif, et al. “Neuroplasticity of Selective Attention: Research Foundations and Preliminary Evidence for a Gene by Intervention Interaction.” _Proceedings of the National Academy of Sciences of the United States of America_, vol. 114, no. 35, Aug. 2017, pp. 9247–9254.
