...
The paper, with its perfectly non-appealing name, "Measuring the Impact of Early-2025 AI on Experienced Open-Source Developer Productivity," is one of those. The brilliant interpretation by Cal Newport (the writer of _Deep Work_) in his podcast _Deep Questions_ adds even more power to this finding.
...
The authors actually planned the research to see how much generative AI _improved_ the efficiency of experienced developers in real work tasks. To test this, they recruited experienced developers from major open-source projects and asked them what their main upcoming contributions were. They then randomly assigned these tasks to two groups: one using AI and one not using AI.

They collected data in a few critical ways:

- **Before the task:** Developers estimated how much time each task would take _with_ and _without_ AI.
    
- **After the task:** Developers estimated the difference in time taken.
    
- **Expert estimation:** AI experts predicted how they believed AI would impact the task completion time.
    
- **Actual time:** They measured the time from the start of the task to its finish (Pull Request accepted).
    
- **Observation:** They recorded the screens of the developers.
    

The results were truly astounding:

While AI experts estimate a 50% speedup 
and the developer themself before the task estimate 24% speed up
And after the task, the developer estimated a 20% speed up
The true result was a **20% slowdown!**
...
It's not that they were completely clueless about their working speed; there was actually a good correlation between their time estimations and real work time _within_ the AI and non-AI task groups. They were just specifically clueless about the **impact of AI** on their overall efficiency.
...
- **Highest Level:** Writing complex code.
    
- **Lower Level:** Prompting the AI.
    
- **No Focus:** Waiting for the AI to generate something.
...
1. **Self-Experiment:** Try to see how different working styles impact your results. Remember that even experienced developers were initially wrong about the impact of AI on their efficiency, so it's better to use some sort of **quantitative, relevant measure** for your efficiency.
    
2. **Be Honest with Yourself:** AI makes your work less mentally demanding, so you might feel a strong desire to prove it also makes you more efficient. You must look at it **objectively**. Incorporating AI into your workflow is also very trendy, so you must ignore the social pressure too.
    
3. **One Tool at a Time:** Good experiments always separate between factors. It is better to incorporate tools slowly than to do it wrongly.
    
4. **Be Mindful:** Try to notice: Did I really get forward, or am I stuck in a comfort zone?
    
5. **Keep Long Chunks of Focus Working Without AI:** This is the first clear result of my self-experiment.
...
- **The paper itself:** `https://arxiv.org/pdf/2507.09089`
    
- **The podcast episode:** `https://open.spotify.com/episode/4gUlqIPkt0GDYi9ZYVJMSm?si=c77839506be74bb1`
