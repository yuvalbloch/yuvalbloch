...
draft: false
title: 'What is LEAN?'
description: 'LEAN — Low Engagement AI News — is a daily morning email digest that summarizes the news calmly, without emotional bait or infinite scroll.'
featured_image: '/lean/what is lean.png'
---
...
1. Articles are pulled from curated RSS feeds produced by professional journalists
2. Duplicate and low-significance stories are filtered out
3. Each remaining article is summarized and rewritten in calm, neutral language
4. The digest is assembled and delivered by email every morning
...
LEAN is also not neutral in a perfect sense. Bias can enter through source selection, model behavior, and summarization constraints. The reader should approach it critically, as they would any curated feed. The [project philosophy](/lean/project-philopsophy/) page explains this in more detail.
...
If that sounds useful, [subscribe to the mailing list](/lean/mailng-list/).
